...
class Customer {
    ...
    constructor(id, company, contact_name, contact_email, number, contact_title, category, notes) {
        this.id = id;
        this.company = company;
        this.contact_name = contact_name;
        this.contact_email = contact_email;
    ...
    async save(worker_list) {
        ...
        try {
            ...
            const newCustomer = await connection.execute(`INSERT INTO customers (company, contact_name, contact_email, contact_phone_number, contact_title, category, notes) VALUES(?, ?, ?, ?, ?, ?, ?)`,
                [this.company, this.contact_name, this.contact_email, this.contact_phone_number, this.contact_title, this.category, this.notes]);
